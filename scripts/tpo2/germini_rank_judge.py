...
# ===== 路径配置 =====
INPUT_PATH = Path("/home/zceexl3/ai_accountant/scripts/tpo2/output/thought_response_20250831_032415.jsonl")
OUTPUT_PATH = Path("/home/zceexl3/ai_accountant/scripts/tpo2/output/preference_pairs_gemini.jsonl")
...
def main():
    ...
    print(f"Dropped placeholders/non-substantive: {dropped_placeholders}")
    print(f"Skipped groups (insufficient valid & distinct): {skipped_insufficient}")
