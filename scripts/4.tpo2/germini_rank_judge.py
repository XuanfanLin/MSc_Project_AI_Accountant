...
# ===== Substantive text check (replacement for is_nonempty) =====
...
def main():
    ...
    # Overwrite the output file to avoid appending old data
    with open(OUTPUT_PATH, "w", encoding="utf-8") as out_f:
        for instr_id, cand_list in tqdm(groups.items(), desc="Evaluating groups"):
            ...
            # From the lowest score upward, find the first valid and distinct one as worst
            worst = None
